...
(function(mallo, undefined) {
  var base_url = "ib://mallo?";
  var apiver =  "1.0";
  var store = {
      android: "market://details?id=net.ib.mallo",
      ios: "http://itunes.apple.com/app/id486244601"
  };
  var packageName = "net.ib.mallo";

  mallo.link = function (name) {
    return {
